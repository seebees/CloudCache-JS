    ...
    this._requestData = function (cloudCacheCmd, path, additionalHeaders) {
        ...
        if ( additionalHeaders ) {
            for ( i in additionalHeaders ) {
                if ( additionalHeaders.hasOwnProperty(i) && !headers[i] ) {
...
CloudCache.prototype._request = function (cmd, path, request_data, encoding, headers, callback) {
    ...
    var self = this,
        request_event = http_cmds.hasOwnProperty(cmd) ? cmd.toLowerCase() : cmd;
...
CloudCache.prototype.put = function (id, data /* ttl, encoding, callback */) {
    ...
    if ( id && !(restricted_ids.hasOwnProperty(id)) ) {
        this._request(
            'PUT',
            ...
            this._request(
                ...
                function (error, data) {
                    var out = (encoding === 'utf8' ?
                            data                   :
                            (new Buffer(data,'utf8')).toString(encoding));
...
var incr = ['incr'],
    decr = ['decr'];
CloudCache.prototype.incr = function (/*id  amount, callback */) {
    return _cr.apply(this, incr.concat(slice(arguments)));
};
CloudCache.prototype.decr = function (/*id  amount, callback */) {
...
function _cr(action, id /* amount, callback */) {
    ...
    if ( id ) {
        this._request(
            ...
            'val=' + String(amount) + '&', //'x-cc-set-if-not-found=1', 
            'utf8',

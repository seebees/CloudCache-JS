    ...
    },
    {
        ...
        del : function (id, callback) {
            return this._REST.
                ...
                on('404', function () {
                    /*
                        CloudCache returns 404 for a "successful" delete of 
                        an id that does not exists.  But since you want it gone
                        anyway, I don't see why you should be sad.  So I return
                        true.
                    */
                    this.success(true);
                }).
        ...
        exists : function (id, callback) {
            ...
            return this._REST.
                ...
                on('404', function () {
                    ...
                    if (typeof this.options.callback === 'function') {
                        this.options.callback(null, false, null);
                    }
                    if (this.options.id) {
                        self.emit(id, 'exits', false, null);
                    }
                }).
        ...
        incr : function (id, options) {
            ...
            return this._REST.
              ...
              //header('x-cc-set-if-not-found',1). //I don't find that this works
                ...
                callback(options.callback).
                form('val=' + String(options.amount)).
                end();
        },
        /**
